...
As a travel enthusiast from a corner of northeast India, I mostly look forward to flying whenever I plan to trips. Since the Covid-19 pandemic ended, aviation market began to recover slowly from rock bottom ticket prices in peak of pandemic. With the war in Ukraine and rise in ATF prices, ticket prices have been through the roof reaching new high. As a result of this, I decided to do an exploratory data analysis for ticket prices to better understand the factors affecting them in India.
...
Check out the project [here](https://github.com/RashmitaC/Indian-Flight-Fare-Analysis/blob/master/Indian%20Flight%20Fare%20Analysis.ipynb)
...
Click on [Power BI Dashboard](https://github.com/RashmitaC/Indian-Flight-Fare-Analysis/blob/master/Indian%20Flight%20Fare%20Dashboard.pdf) to view the dashboard
